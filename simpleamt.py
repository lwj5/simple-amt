...
def setup_qualifications(hit_properties, mtc):
  ...
  """
    qual = []
    if (
        "QualificationId" in hit_properties
        and "QualificationComparator" in hit_properties
        and "QualificationInteger" in hit_properties
    ):
        ...
        if comparator == ">":
            ...
            print(
                "The 'qualification comparator' is not one of the designated"
                + "values ('<', '=', '>')."
            )
        qual.append(
            {
